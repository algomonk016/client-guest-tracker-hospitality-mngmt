...
const GuestLogin = () => {
    ...
    return (
        <div className="flex items-center justify-center pb-12 px-4 sm:px-6 lg:px-8 bg-purple-200 h-screen">
            <div className="max-w-md w-full space-y-8 bg-gray-50 border-0 shadow rounded p-10">
                <div className="mb-5">
                    <img
                        ...
                        alt="Workflow"
                    />
                    <h2 className="mt-10 text-center text-3xl font-extrabold text-gray-900"> Guest Login </h2>
                </div>
